...
@Component({
    templateUrl: './manual-requisition-dialog.component.html',
    providers: [DepartmentalRequisitionsModel, DepartmentalRequisitionsService]
})
export class ManualRequisitionDialogComponent extends AppSharedUrlComponent implements OnInit {
    constructor(private service: DepartmentalRequisitionsService, public model: DepartmentalRequisitionsModel, private toast: ToastrService,
        public dialogRef: MatDialogRef<ManualRequisitionDialogComponent>, @Inject(MAT_DIALOG_DATA) public dialogData: DepartmentalRequisitionsModel,
    ...
    ngOnInit() {
        ...
        if (this.dialogData != null) {
            this.title = 'Add Manual Requisition';
            ...
            this.title = 'Edit Manual Requisition';
    ...
    onSubmit(manualRequisitionForm: any) {
        if (manualRequisitionForm.invalid) {
            ...
            this.model.isHQInventoryDeptRequisition=false;
